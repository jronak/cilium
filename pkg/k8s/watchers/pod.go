...
func (k *K8sPodWatcher) dscpMarkingEnabled() bool {
	return k.bandwidthManager != nil && k.bandwidthManager.DSCPMarkingEnabled()
}
...
func (k *K8sPodWatcher) updateK8sPodV1(ctx context.Context, oldK8sPod, newK8sPod *slim_corev1.Pod) error {
	...
	annoChangedDSCP := k.dscpMarkingEnabled() && !k8s.AnnotationsEqual([]string{bandwidth.EgressDSCP}, oldAnno, newAnno)
